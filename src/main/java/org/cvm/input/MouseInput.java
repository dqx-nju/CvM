...
public class MouseInput {
    ...
    private final void handleMouseMoved(MouseEvent event) {
        point(event.getX(), event.getY());
    }
    private final void handleMousePressed(MouseEvent event) {
        press(Mouse.find(event.getButton()), event.getX(), event.getY());
    }
    private final void handleMouseReleased(MouseEvent event) {
        release(Mouse.find(event.getButton()), event.getX(), event.getY());
    }
    private final void handleMouseDragged(MouseEvent event) {
        point(event.getX(), event.getY());
        drag(Mouse.find(event.getButton()), event.getX(), event.getY());
    }
    private final void handleMouseScrolled(ScrollEvent event) {
